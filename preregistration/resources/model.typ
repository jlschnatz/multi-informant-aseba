...
#diagram(
  ...
  // Covariance
  edge(CIC, CIP, label: text(orange)[$gamma arrow.t$], label-side: center, marks: "-|>", stroke: orange),
  edge(ISC, ISP, label: text(navy)[$phi arrow.b$], label-side: center, marks: "<|-|>", stroke: navy, bend: -30deg, label-fill: white),
